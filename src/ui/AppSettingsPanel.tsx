...
const EFFECT_CONTROL_KEYS = {
  ...
  lens: {
    ...
    cameraOrbitAmount: "lensCameraOrbitAmount",
    cameraOrbitSpeed: "lensCameraOrbitSpeed",
      ...
      [t("settings.battleDisplay")]: folder(
        {
          ...
          [t(EFFECT_LABEL_KEYS.lens)]: effectFolder("lens", EFFECT_CONTROL_KEYS.lens.enabled, {
            ...
            [EFFECT_CONTROL_KEYS.lens.cameraOrbitAmount]: slider("lens", "cameraOrbitAmount", "effects.lensCameraOrbitAmount", 0, 0.45, 0.01),
            [EFFECT_CONTROL_KEYS.lens.cameraOrbitSpeed]: slider("lens", "cameraOrbitSpeed", "effects.lensCameraOrbitSpeed", 0, 0.6, 0.01),
...
function settingsToLevaValues(settings: BattlePostEffectSettings): LevaSetValues {
  return {
    ...
    [EFFECT_CONTROL_KEYS.lens.cameraOrbitAmount]: settings.effects.lens.cameraOrbitAmount,
    [EFFECT_CONTROL_KEYS.lens.cameraOrbitSpeed]: settings.effects.lens.cameraOrbitSpeed,
