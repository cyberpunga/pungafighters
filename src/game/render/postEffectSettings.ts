...
export const DEFAULT_BATTLE_POST_EFFECT_CONFIGS = {
  ...
  lens: {
    ...
    hitBoost: 1.15,
    superBoost: 2.45,
    cameraOrbitAmount: 0.16,
    cameraOrbitSpeed: 0.18,
  ...
  return {
    ...
    effects: {
      ...
      lens: {
        ...
        cameraOrbitAmount: readNumber(effectsValue.lens, "cameraOrbitAmount", base.effects.lens.cameraOrbitAmount),
        cameraOrbitSpeed: readNumber(effectsValue.lens, "cameraOrbitSpeed", base.effects.lens.cameraOrbitSpeed),
